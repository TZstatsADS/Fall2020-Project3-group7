...
#Since RF took too long to train, the following is the screenshot of result using tunning parameter
![Figure3](../figs/RF_result.jpeg)
```{r}
...
Summary table
![Figure4](../figs/model_summary.jpg)
```{r, summary table}
Table<-running_time%>%
